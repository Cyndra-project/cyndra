...
#[schema(as = cyndra_common::resource::Response)]
pub struct Response {
    /// The type of this resource.
    #[schema(value_type = cyndra_common::resource::Type)]
    pub r#type: Type,
...
#[schema(as = cyndra_common::resource::Type)]
pub enum Type {
    #[schema(value_type = cyndra_common::database::Type)]
