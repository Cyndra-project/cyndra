...
use super::{
    ...
    headers::XCyndraAdminSecret,
};

pub const EXP_MINUTES: i64 = 5;
const ISS: &str = "cyndra";
const PUBLIC_KEY_CACHE_KEY: &str = "cyndra.public-key";
    ...
    S::Future: Send + 'static,
{
    ...
    fn call(&mut self, req: Request<Body>) -> Self::Future {
        let error = match req.headers().typed_try_get::<XCyndraAdminSecret>() {
...
/// The scope of operations that can be performed on cyndra
