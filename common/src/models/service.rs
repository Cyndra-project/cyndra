...
#[schema(as = cyndra_common::models::service::Response)]
pub struct Response {
...
#[derive(Deserialize, Serialize, ToSchema)]
#[schema(as = cyndra_common::models::service::Summary)]
pub struct Summary {
    pub name: String,
    #[schema(value_type = cyndra_common::models::deployment::Response)]
