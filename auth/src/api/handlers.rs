...
use cyndra_common::{backends::auth::Claim, models::auth};
...
pub(crate) async fn convert_cookie(
...
) -> Result<Json<cyndra_common::backends::auth::ConvertResponse>, StatusCode> {
    ...
    let response = cyndra_common::backends::auth::ConvertResponse {
