...
impl FromStr for ProjectName {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        s.parse::<cyndra_common::project::ProjectName>()
...
impl From<ProjectDetails> for cyndra_common::models::project::AdminResponse {
...
pub mod tests {
    ...
    use cyndra_common::deployment::State;
    use cyndra_common::log;
    use cyndra_common::models::{deployment, project, service, user};
    use sqlx::SqlitePool;
    ...
    async fn end_to_end() {
        ...
        proxy_client
            .request(
                Request::get("/hello")
                    .header("Host", "matrix.test.cyndraapp.rs")
                    .header("x-cyndra-project", "matrix")
                    .body(Body::empty())
                    .unwrap(),
            )
            .map_ok(|resp| {
