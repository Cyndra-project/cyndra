...
pub struct StartArgs {
    ...
    #[arg(long, default_value = "https://console.cyndra.rs")]
...
pub struct ServiceArgs {
    ...
    #[arg(long, default_value = "public.ecr.aws/cyndra/deployer:latest")]
    pub image: String,
    /// Prefix to add to the name of all docker resources managed by
    /// this service
    #[arg(long, default_value = "cyndra_prod_")]
    pub prefix: String,
    ...
    #[arg(long, default_value = "cyndra_default")]
    pub network_name: String,
    /// FQDN where the proxy can be reached at
    #[arg(long, default_value = "cyndraapp.rs")]
    pub proxy_fqdn: FQDN,
