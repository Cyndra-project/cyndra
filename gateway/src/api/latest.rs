...
use super::auth_layer::CyndraAuthLayer;
use super::project_caller::ProjectCaller;

pub const SVC_DEGRADED_THRESHOLD: usize = 128;
pub const cyndra_GATEWAY_VARIANT: &str = "cyndra-gateway";
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Successfully got a specific project information.", body = cyndra_common::models::project::Response),
...
#[utoipa::path(
    ...
    path = "/projects",
    responses(
        (status = 200, description = "Successfully got the projects list.", body = [cyndra_common::models::project::Response]),
        (status = 500, description = "Server internal error.")
    ),
    params(
        PaginationDetails
...
#[utoipa::path(
    ...
    path = "/projects/{project_name}",
    responses(
        (status = 200, description = "Successfully created a specific project.", body = cyndra_common::models::project::Response),
        (status = 500, description = "Server internal error.")
    ),
    params(
        ("project_name" = String, Path, description = "The name of the project."),
...
#[utoipa::path(
    ...
    path = "/projects/{project_name}",
    responses(
        (status = 200, description = "Successfully destroyed a specific project.", body = cyndra_common::models::project::Response),
        (status = 500, description = "Server internal error.")
    ),
    params(
        ("project_name" = String, Path, description = "The name of the project."),
...
async fn destroy_project(
    ...
    if response.state == cyndra_common::models::project::State::Destroyed {
    ...
    response.state = cyndra_common::models::project::State::Destroying;
...
#[instrument(skip_all, fields(cyndra.project.name = %scoped_user.scope))]
#[utoipa::path(
    delete,
    path = "/projects/{project_name}/delete",
    responses(
        (status = 200, description = "Successfully deleted a project, unless dry run.", body = cyndra_common::models::project::Response),
...
async fn route_project(
        ...
        && uri_path == format!("/projects/{}/services/{}", project_name, project_name)
    {
        ...
        tokio::spawn(async move {
            let event = async_posthog::Event::new("cyndra_api_start_deployment", &account_name);
...
async fn get_status(
    ...
    if sender.is_closed() || sender.capacity() == 0 {
        statuses.push((cyndra_GATEWAY_VARIANT, StatusResponse::unhealthy()));
    } else if sender.capacity() < WORKER_QUEUE_SIZE - SVC_DEGRADED_THRESHOLD {
        statuses.push((cyndra_GATEWAY_VARIANT, StatusResponse::degraded()));
    } else {
        statuses.push((cyndra_GATEWAY_VARIANT, StatusResponse::healthy()));
    };
    ...
    statuses.push(("cyndra-provisioner", provisioner_status));
    ...
    statuses.push(("cyndra-auth", auth_status));
...
#[utoipa::path(
    ...
    path = "/stats/load",
    responses(
        (status = 200, description = "Successfully fetched the build queue load.", body = cyndra_common::models::stats::LoadResponse),
        (status = 500, description = "Server internal error.")
    )
)]
async fn post_load(
...
#[utoipa::path(
    ...
    path = "/stats/load",
    responses(
        (status = 200, description = "Successfully removed the build with the ID specified in the load request from the build queue.", body = cyndra_common::models::stats::LoadResponse),
        (status = 500, description = "Server internal error.")
    )
)]
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Successfully gets the build queue load as an admin.", body = cyndra_common::models::stats::LoadResponse),
        (status = 500, description = "Server internal error.")
    )
)]
...
#[utoipa::path(
    ...
    path = "/admin/stats/load",
    responses(
        (status = 200, description = "Successfully clears the build queue.", body = cyndra_common::models::stats::LoadResponse),
        (status = 500, description = "Server internal error.")
    )
)]
...
#[instrument(skip_all, fields(cyndra.project.name = %project_name, %fqdn))]
#[utoipa::path(
    post,
...
#[utoipa::path(
    ...
    path = "/admin/projects",
    responses(
        (status = 200, description = "Successfully fetched the projects list.", body = cyndra_common::models::project::AdminResponse),
        (status = 500, description = "Server internal error.")
    )
)]
...
pub mod tests {
    ...
    use cyndra_common::constants::limits::{MAX_PROJECTS_DEFAULT, MAX_PROJECTS_EXTRA};
