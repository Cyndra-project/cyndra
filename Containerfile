...
FROM rust:${RUSTUP_TOOLCHAIN}-buster as cyndra-build
RUN apt-get update &&\
...
# This is used to carry over in the docker images any *.pem files from cyndra root directory, to be used for TLS testing, as described
