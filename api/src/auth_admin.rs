...
lazy_static! {
    static ref cyndra_ADMIN_SECRET: String =
        std::env::var("cyndra_ADMIN_SECRET").expect("cyndra_ADMIN_SECRET env var not found!");
}
...
impl<'r> FromRequest<'r> for Admin {
    ...
    async fn from_request(req: &'r Request<'_>) -> Outcome<Self, Self::Error> {
        ...
        if admin_secret.0 == *cyndra_ADMIN_SECRET {
