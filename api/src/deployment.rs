use crate::{build::Build, BuildSystem, CyndraFactory};
use anyhow::{anyhow, Context as AnyhowContext};
use core::default::Default;
use cyndra_common::project::ProjectConfig;
use cyndra_common::{DeploymentApiError, DeploymentId, DeploymentMeta, DeploymentStateMeta, Host, Port};
...
impl Deployment {
    ...
    fn from_directory(dir: DirEntry) -> Result<Self, anyhow::Error> {
        ...
        let marker_path = project_path.join(".cyndra_marker");
            ...
            *state = match state.take() {
                ...
                DeploymentState::Loaded(mut loaded) => {
                    ...
                    match db_state.ensure().await {
                        ...
                        Ok(()) => {
                            let mut factory = CyndraFactory::new(&mut db_state);
...
type ServeHandle = JoinHandle<Result<(), cyndra_service::Error>>;
...
enum DeploymentState {
    ...
    /// implementation of the [`cyndra_service::Service`] trait.
    Loaded(LoadedState),
