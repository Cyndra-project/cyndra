  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        {
          name = "cyndra_USERS_TOML",
          value = "/opt/cyndra/users/users.toml"
        },
        {
          name = "PG_PASSWORD",
      ...
      mountPoints = [
        {
          ...
          containerPath = "/opt/cyndra/"
        },
        {
          sourceVolume = "postgres-conf"
          containerPath = "/etc/postgresql/11/cyndra/"
        }
      ]
    }
  ])
