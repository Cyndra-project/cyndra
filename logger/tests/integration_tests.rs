...
use cyndra_common_tests::JwtScopesLayer;
use cyndra_logger::{Service, CyndraLogsOtlp, Sqlite};
...
async fn generate_and_get_runtime_logs() {
    ...
    tokio::task::spawn(async move {
        ...
        Server::builder()
            ...
            .add_service(TraceServiceServer::new(CyndraLogsOtlp::new(
                sqlite.get_sender(),
            )))
...
/// For the cyndra-runtime logs we want to add the deployment id to the top level attributes,
