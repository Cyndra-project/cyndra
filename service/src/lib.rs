...
//! ## Deploying
//!
//! You can deploy your service with the [`cargo cyndra`](https://docs.rs/crate/cargo-cyndra/latest) subcommand. To install run:
//!
//! ```bash
...
//!
//! ```bash
//! $ curl https://hello-world-rocket-app.cyndraapp.rs
//! Hello, world!
//! ```
//!
//! ## Using `sqlx`
