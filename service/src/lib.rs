...
//! ```
//!
//! See the [cyndra_service::main][main] macro for more information on how to implement a service. Here's a simple example using [rocket][rocket] to get you started:
//!
//! ```rust,no_run
//! #[macro_use]
//! extern crate rocket;
...
/// The following type can take the place of the `Ok` type and enjoy first class service support in cyndra.
///
/// | Ok type           | Service  |
/// | ----------------- | -------- |
/// | [`Rocket<Build>`] | [rocket] |
...
/// The following dependencies can be managed by cyndra:
///
