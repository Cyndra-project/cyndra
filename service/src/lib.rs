...
//! ```
//!
//! Now that cyndra is installed, you can initialize a project with Rocket boilerplate:
//! ```bash
...
//!
//! ```toml
//! cyndra-shared-db = { version = "0.8.0", features = ["postgres"] }
...
/// | `CyndraPoise`                        | bot-poise    | [poise](https://docs.rs/poise/0.5.2)        | 0.5.2      | [GitHub](https://github.com/cyndra-hq/examples/tree/main/poise/hello-world)          |
/// | `CyndraActixWeb`                     | web-actix-web| [actix-web](https://docs.rs/actix-web/4.2.1)| 4.2.1      | [GitHub](https://github.com/cyndra-hq/examples/tree/main/actix-web/hello-world)      |
///
...
pub use cyndra_common::project::ProjectName as ServiceName;
...
// See https://github.com/cyndra-hq/cyndra/pull/348
#[allow(dead_code)]
...
#[cfg(feature = "web-poem")]
pub type CyndraPoem<T> = Result<T, Error>;
...
#[cfg(feature = "web-warp")]
pub type CyndraWarp<T> = Result<warp::filters::BoxedFilter<T>, Error>;
...
#[cfg(feature = "web-actix-web")]
pub type CyndraActixWeb<F> = Result<F, Error>;
...
#[cfg(feature = "web-salvo")]
pub type CyndraSalvo = Result<salvo::Router, Error>;
...
#[cfg(feature = "web-thruster")]
pub type CyndraThruster<T> = Result<T, Error>;
...
#[cfg(feature = "bot-serenity")]
pub type CyndraSerenity = Result<serenity::Client, Error>;
...
#[cfg(feature = "bot-poise")]
pub type CyndraPoise<T, E> = Result<std::sync::Arc<poise::Framework<T, E>>, Error>;
