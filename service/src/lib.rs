...
pub use cyndra_proto::provisioner::{ContainerRequest, ContainerResponse};
...
pub trait Factory: Send + Sync {
    /// Provision a Cyndra database and get the connection information
...
/// The [`Factory`] in [`ResourceBuilder::output`] can be used to provision resources on Cyndra's servers if your service will need any.
///
...
pub trait ResourceBuilder: Default {
    ...
    /// If dealing with a Cyndra-provisioned resource, such as a database, use the corresponding variant.
