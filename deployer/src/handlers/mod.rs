...
use cyndra_proto::logger::LogsRequest;
...
#[openapi(
    ...
    components(schemas(
        cyndra_common::models::service::Summary,
        cyndra_common::resource::Response,
        cyndra_common::resource::Type,
        cyndra_common::database::Type,
        cyndra_common::database::AwsRdsEngine,
        cyndra_common::database::SharedEngine,
        cyndra_common::models::service::Response,
        cyndra_common::models::deployment::Response,
        cyndra_common::log::LogItem,
        cyndra_common::deployment::State,
    ))
)]
pub struct ApiDoc;
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Lists the services owned by a project.", body = [cyndra_common::models::service::Response]),
...
) -> Result<Json<Vec<cyndra_common::models::service::Response>>> {
...
#[instrument(skip_all, fields(cyndra.project.name = %project_name, cyndra.service.name = %service_name))]
#[utoipa::path(
    get,
    path = "/projects/{project_name}/services/{service_name}",
    responses(
        (status = 200, description = "Gets a specific service summary.", body = cyndra_common::models::service::Summary),
        (status = 500, description = "Database error.", body = String),
...
pub async fn get_service(
...
) -> Result<Json<cyndra_common::models::service::Summary>> {
    if let Some(service) = persistence.get_service_by_name(&service_name).await? {
        ...
        let response = cyndra_common::models::service::Summary {
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Gets a specific service resources.", body = cyndra_common::resource::Response),
        (status = 500, description = "Database error.", body = String),
        (status = 404, description = "Record could not be found.", body = String),
    ),
    params(
...
pub async fn get_service_resources(
    ...
    CustomErrorPath((project_name, service_name)): CustomErrorPath<(String, String)>,
) -> Result<Json<Vec<cyndra_common::resource::Response>>> {
    if let Some(service) = persistence.get_service_by_name(&service_name).await? {
        let resources = persistence
            ...
            .resources
            .into_iter()
            .map(cyndra_common::resource::Response::try_from)
...
#[instrument(skip_all, fields(cyndra.project.name = %project_name, cyndra.service.name = %service_name, %resource_type))]
#[utoipa::path(
    delete,
...
pub async fn delete_service_resource(
    ...
    let r#type =
        cyndra_common::resource::Type::from_str(resource_type.as_str()).map_err(|err| {
            error::Error::Convert {
                from: "str".to_string(),
                to: "cyndra_common::resource::Type".to_string(),
...
#[utoipa::path(
    ...
    path = "/projects/{project_name}/services/{service_name}",
    responses(
        (status = 200, description = "Creates a specific service owned by a specific project.", body = cyndra_common::models::deployment::Response),
...
) -> Result<Json<cyndra_common::models::deployment::Response>> {
    let id = Uuid::new_v4();
    let now = Utc::now();
...
#[utoipa::path(
    ...
    path = "/projects/{project_name}/services/{service_name}",
    responses(
        (status = 200, description = "Stops a specific service owned by a specific project.", body = cyndra_common::models::service::Summary),
        (status = 500, description = "Database error.", body = String),
        (status = 404, description = "Record could not be found.", body = String),
    ),
    params(
...
#[instrument(skip_all, fields(cyndra.project.name = %project_name, page, limit))]
#[utoipa::path(
    get,
    path = "/projects/{project_name}/deployments",
    responses(
        (status = 200, description = "Gets deployments information associated to a specific project.", body = cyndra_common::models::deployment::Response),
        (status = 500, description = "Database error.", body = String),
        (status = 404, description = "Record could not be found.", body = String),
    ),
    params(
...
) -> Result<Json<Vec<cyndra_common::models::deployment::Response>>> {
...
#[instrument(skip_all, fields(cyndra.project.name = %project_name, %deployment_id))]
#[utoipa::path(
    get,
    path = "/projects/{project_name}/deployments/{deployment_id}",
    responses(
        (status = 200, description = "Gets a specific deployment information.", body = cyndra_common::models::deployment::Response),
        (status = 500, description = "Database or streaming error.", body = String),
        (status = 404, description = "Record could not be found.", body = String),
    ),
    params(
...
#[utoipa::path(
    ...
    path = "/projects/{project_name}/deployments/{deployment_id}",
    responses(
        (status = 200, description = "Deletes a specific deployment.", body = cyndra_common::models::deployment::Response),
        (status = 500, description = "Database or streaming error.", body = String),
        (status = 404, description = "Record could not be found.", body = String),
    ),
    params(
...
#[utoipa::path(
    ...
    path = "/projects/{project_name}/deployments/{deployment_id}",
    responses(
        (status = 200, description = "Started a specific deployment.", body = cyndra_common::models::deployment::Response),
        (status = 500, description = "Database or streaming error.", body = String),
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Gets the logs a specific deployment.", body = [cyndra_common::log::LogItem]),
        (status = 500, description = "Database or streaming error.", body = String),
        (status = 404, description = "Record could not be found.", body = String),
    ),
    params(
...
#[instrument(skip_all, fields(cyndra.project.name = %project_name))]
#[utoipa::path(
    get,
...
async fn logs_websocket_handler(
    ...
    loop {
        match stream.message().await {
            ...
            Err(error) => {
                trace!(?error, "the logs stream was closed by Cyndra");
                let _ = s
                    .send(ws::Message::Text(
                        "The logs stream was closed by Cyndra because of an internal error"
                            .to_string(),
                    ))
                    .await;
                break;
