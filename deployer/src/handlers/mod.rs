...
#[openapi(
    ...
    components(schemas(
        ...
        cyndra_common::models::secret::Response,
...
#[utoipa::path(
    ...
    responses(
        (status = 200, description = "Gets the secrets a specific service.", body = [cyndra_common::models::secret::Response]),
        (status = 500, description = "Database or streaming error.", body = String),
        (status = 404, description = "Record could not be found.", body = String),
    ),
    params(
...
pub async fn clean_project(
    ...
    cyndra_service::builder::clean_crate(
        deployment_manager
            .builds_path()
            .join(project_name)
            .as_path(),
