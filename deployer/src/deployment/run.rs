...
mod tests {
    ...
    use async_trait::async_trait;
    use portpicker::pick_unused_port;
    use cyndra_common::{claims::Claim, storage_manager::ArtifactsStorageManager};
    use cyndra_common_tests::logger::{mocked_logger_client, MockedLogger};
    use cyndra_proto::{
        logger::Batcher,
        provisioner::{
    ...
    impl ResourceManager for StubResourceManager {
        ...
        async fn insert_resources(
            &mut self,
            _resources: Vec<cyndra_proto::resource_recorder::record_request::Resource>,
