...
use cyndra_proto::resource_recorder::{record_request, ResourcesResponse, ResultResponse};
use sqlx::{
...
impl From<Type> for cyndra_common::resource::Type {
...
impl From<cyndra_common::resource::Type> for Type {
    fn from(r#type: cyndra_common::resource::Type) -> Self {
        match r#type {
            cyndra_common::resource::Type::Database(r#type) => Self::Database(r#type.into()),
            cyndra_common::resource::Type::Secrets => Self::Secrets,
            cyndra_common::resource::Type::StaticFolder => Self::StaticFolder,
            cyndra_common::resource::Type::Persist => Self::Persist,
            cyndra_common::resource::Type::Turso => Self::Turso,
            cyndra_common::resource::Type::ServiceInfo => Self::ServiceInfo,
            cyndra_common::resource::Type::Custom => Self::Custom,
        }
    }
}
