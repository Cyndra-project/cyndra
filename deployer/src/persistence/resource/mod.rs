...
impl From<Resource> for cyndra_common::models::resource::Response {
    fn from(resource: Resource) -> Self {
        cyndra_common::models::resource::Response {
...
impl From<Type> for cyndra_common::models::resource::Type {
