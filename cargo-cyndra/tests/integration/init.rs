...
async fn non_interactive_basic_init() {
    ...
    assert!(cargo_toml.contains("cyndra-service = "));
}

// TODO: unignore when cyndra-rocket is published
#[ignore]
#[tokio::test]
...
fn interactive_rocket_init() -> Result<(), Box<dyn std::error::Error>> {
    ...
    session.exp_string(
        "How do you want to name your project? It will be hosted at ${project_name}.cyndraapp.rs.",
    )?;
