...
use cyndra_common::{
    constants::{
        headers::X_CARGO_cyndra_VERSION, EXAMPLES_REPO, RUNTIME_NAME, cyndra_API_URL,
        cyndra_CONSOLE_URL, STORAGE_DIRNAME, TEMPLATES_SCHEMA_VERSION,
    },
    models::{
...
mod tests {
    ...
    async fn get_archive_entries(
        ...
        let mut cyndra = Cyndra::new(crate::Binary::Cyndra).unwrap();
        cyndra
