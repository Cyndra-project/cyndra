...
impl Cyndra {
        ...
        if !should_create_environment {
            ...
            if serenity_idle_hint {
                printdoc!(
                    ...
                    project so that they don't go offline: https://docs.cyndra.rs/getting-started/idle-projects
                    "
                );
            }
        }
    ...
    async fn project_create(&self, idle_minutes: u64) -> Result<CommandOutcome> {
        ...
        if idle_minutes > 0 {
            ...
            println!("To change the idle time refer to the docs: https://docs.cyndra.rs/getting-started/idle-projects");
            println!();
        }
