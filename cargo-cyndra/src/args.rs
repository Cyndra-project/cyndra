...
use cyndra_common::constants::{DEFAULT_IDLE_MINUTES, EXAMPLES_REPO};
...
pub struct CyndraArgs {
    ...
    #[arg(global = true, long, env = "cyndra_API")]
...
///
/// See the CLI docs (https://docs.cyndra.rs/getting-started/cyndra-commands)
