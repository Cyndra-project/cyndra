...
use cyndra_common::constants::{DEFAULT_IDLE_MINUTES, EXAMPLES_REPO, cyndra_CONSOLE_URL};
...
#[command(
    ...
    arg(clap::Arg::new("dummy")
        .value_parser([PossibleValue::new("cyndra")])
        .required(false)
        .hide(true))
)]
pub struct CyndraArgs {
    ...
    #[arg(global = true, long, env = "cyndra_DEBUG")]
    pub debug: bool,
    /// Target Cyndra's development environment
    #[arg(global = true, long, env = "cyndra_BETA", hide = true)]
    pub beta: bool,
    #[command(flatten)]
...
#[derive(Subcommand)]
pub enum Command {
    /// Generate a Cyndra project from a template
    Init(InitArgs),
    ...
    Status,
    /// Stop a Cyndra service
    Stop,
    /// View build and deployment logs
    Logs(LogsArgs),
    /// Manage Cyndra projects
    ...
    Clean,
    /// Show info about your Cyndra account
    #[command(visible_alias = "acc")]
    Account,
    /// Log in to the Cyndra platform
    Login(LoginArgs),
    ...
    Feedback,
    /// Upgrade the cargo-cyndra binary
    Upgrade {
...
pub enum ProjectCommand {
    ...
    /// Link this workspace to a Cyndra project
    Link,
}
...
pub struct LoginArgs {
    ...
    pub prompt: bool,
    /// Log in with this Cyndra API key
    #[arg(long)]
    pub api_key: Option<String>,
    /// URL to the Cyndra Console for automatic login
    #[arg(long, env = "cyndra_CONSOLE", default_value = cyndra_CONSOLE_URL, hide_default_value = true)]
...
pub struct DeployArgs {
    ...
    pub image: Option<String>, // TODO?: Make this a subcommand instead? `cyndra deploy image ...`
...
pub struct InitArgs {
    ...
    #[arg(long)]
    pub force_name: bool,
    /// Whether to start the container for this project on Cyndra, and claim the project name
    #[arg(long)]
    pub create_env: bool,
