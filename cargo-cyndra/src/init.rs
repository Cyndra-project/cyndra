...
impl Framework {
    ...
    pub fn init_config(&self) -> Box<dyn CyndraInit> {
        match self {
            Framework::ActixWeb => Box::new(CyndraInitActixWeb),
            Framework::Axum => Box::new(CyndraInitAxum),
            Framework::Rocket => Box::new(CyndraInitRocket),
            Framework::Tide => Box::new(CyndraInitTide),
            Framework::Tower => Box::new(CyndraInitTower),
...
pub fn cargo_cyndra_init(path: PathBuf, framework: Framework) -> Result<()> {
