...
use cyndra_service::database::Type;
...
impl LocalProvisioner {
    ...
    async fn get_container(
        ...
        match self.docker.inspect_container(container_name, None).await {
            ...
            Err(error) => {
                ...
                error!(
                    "Make sure Docker is installed and running. For more help: https://docs.cyndra.rs/getting-started/local-run#docker-engines"
                );
    ...
    async fn get_db_connection_string(
        ...
        let container_name = format!("cyndra_{project_name}_{type}");
    ...
    pub async fn start_container(
        ...
        let container_name = format!("cyndra_{project_name}_{container_name}");
...
pub mod beta {
    ...
    use cyndra_proto::provisioner::{provisioner_server::Provisioner, DatabaseRequest};
    use cyndra_service::CyndraResourceOutput;
    use tonic::Request;
    use tracing::debug;
        ...
        Ok(match (method, uri) {
            ...
            (Method::POST, "/projects/proj_LOCAL/resources") => {
                ...
                let response = match cyndra_resource.r#type {
                    ...
                    resource::Type::Secrets => CyndraResourceOutput {
