...
pub(crate) fn wasi_bindings(app: App) -> proc_macro2::TokenStream {
    quote!(
        ...
        pub extern "C" fn __cyndra_Axum_call(
            ...
            let wrapper: cyndra_common::wasm::RequestWrapper = rmp_serde::from_read(reader).unwrap();
            ...
            let response_parts = cyndra_common::wasm::ResponseWrapper::from(parts).into_rmp();
