...
pub static X_cyndra_CTL_SECRET: HeaderName = HeaderName::from_static("x-cyndra-ctl-secret");

pub struct XCyndraCtlSecret(pub String);

impl Header for XCyndraCtlSecret {
    fn name() -> &'static HeaderName {
        &X_cyndra_CTL_SECRET
    }
