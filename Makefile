...
.PHONY: images clean src up down deploy cyndra-% cyndra-images postgres docker-compose.rendered.yml test bump-% deploy-examples publish publish-% --validate-version

clean:
	rm .cyndra-*
	rm docker-compose.rendered.yml

images: cyndra-images postgres panamax otel

cyndra-images: cyndra-auth cyndra-deployer cyndra-gateway cyndra-provisioner cyndra-resource-recorder
