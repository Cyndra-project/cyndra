...
RUST_LOG?=nbuild_core=warn,cyndra=debug,info
else
...
.PHONY: clean images the-cyndra-images cyndra-% postgres panamax otel deploy test docker-compose.rendered.yml up down
