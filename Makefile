SRC_CRATES=auth cargo-cyndra codegen common deployer gateway logger proto provisioner resource-recorder service
...
.PHONY: clean images postgres panamax otel deploy test docker-compose.rendered.yml up down cyndra-%

clean:
	rm .cyndra-*
	rm docker-compose.rendered.yml

images: cyndra-auth cyndra-deployer cyndra-gateway cyndra-logger cyndra-provisioner cyndra-resource-recorder otel panamax postgres
