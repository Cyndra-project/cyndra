...
.PHONY: images clean src up down deploy docker-compose.rendered.yml cyndra-% postgres docker-compose.rendered.yml test

clean:
	rm .cyndra-*
	rm docker-compose.rendered.yml

images: cyndra-provisioner cyndra-deployer postgres
