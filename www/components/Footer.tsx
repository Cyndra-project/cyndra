...
const navigation = [
  {
    ...
    links: [
      ...
      {
        name: "Roadmap",
        href: "https://github.com/orgs/cyndra-hq/projects/4/views/2",
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        name: "Careers",
        href: "https://www.workatastartup.com/companies/cyndra",
      },
    ],
  },
  {
    ...
    links: [
      {
        name: "Documentation",
        href: "https://docs.rs/cyndra-service/latest/cyndra_service/",
      },
      {
        name: "Guides",
        href: "https://github.com/cyndra-hq/cyndra/tree/main/examples",
      },
      {
        name: "Contributors",
        href: "https://github.com/cyndra-hq/cyndra/graphs/contributors",
      },
    ],
  },
  {
    ...
    links: [
      ...
      {
        name: "Linkedin",
        href: "https://www.linkedin.com/company/cyndra-yc/",
      },
    ],
  },
];
    ...
    <>
      ...
      <footer className="mx-auto max-w-6xl py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex flex-col gap-2 sm:flex-row">
          <p className="text-base dark:text-gray-300">&copy; 2022 cyndra</p>
