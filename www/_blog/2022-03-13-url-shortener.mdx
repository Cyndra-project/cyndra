...
`cyndra` does a lot of this stuff for you - I just didn't remember how. I quickly head over to the [cyndra / sqlx](https://docs.rs/cyndra-service/0.2.5/cyndra_service/#using-sqlx) section in the docs. I added the `sqlx` dependency to `Cargo.toml` and change *one line* in `lib.rs`:
