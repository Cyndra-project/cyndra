...
pub mod runtime {
    ...
    impl TryFrom<LogItem> for cyndra_common::LogItem {
    ...
    impl From<LogLevel> for cyndra_common::log::Level {
    ...
    impl From<cyndra_common::wasm::Log> for LogItem {
        fn from(log: cyndra_common::wasm::Log) -> Self {
            ...
            Self {
                ...
                target: log.target,
                fields: log.fields,
                // We can safely assume the state received from cyndra-next to be running,
    ...
    impl From<cyndra_common::wasm::Level> for LogLevel {
        fn from(level: cyndra_common::wasm::Level) -> Self {
            match level {
                cyndra_common::wasm::Level::Trace => Self::Trace,
                cyndra_common::wasm::Level::Debug => Self::Debug,
                cyndra_common::wasm::Level::Info => Self::Info,
                cyndra_common::wasm::Level::Warn => Self::Warn,
                cyndra_common::wasm::Level::Error => Self::Error,
            }
        }
    }
...
pub mod resource_recorder {
    ...
    impl TryFrom<record_request::Resource> for cyndra_common::resource::Response {
        type Error = anyhow::Error;

        fn try_from(resource: record_request::Resource) -> Result<Self, Self::Error> {
            let r#type = cyndra_common::resource::Type::from_str(resource.r#type.as_str())
                .map_err(anyhow::Error::msg)
                .context("resource type should have a valid resource string")?;
            let response = cyndra_common::resource::Response {
                r#type,
    ...
    impl TryFrom<Resource> for cyndra_common::resource::Response {
        type Error = anyhow::Error;
