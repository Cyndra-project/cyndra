...
pub mod resource_recorder {
    ...
    impl From<record_request::Resource> for cyndra_common::resource::Response {
        fn from(resource: record_request::Resource) -> Self {
            cyndra_common::resource::Response {
                r#type: cyndra_common::resource::Type::from_str(resource.r#type.as_str())
    ...
    impl From<Resource> for cyndra_common::resource::Response {
