...
Compile the cyndra-next serenity runtime:
...
``` bash
# load wasm module
grpcurl -plaintext -import-path ../proto -proto runtime.proto -d '{"service_name": "Tonic", "path": "/home/<path to cyndra>/runtime/serenity.wasm"}' localhost:6001 runtime.Runtime/Load
