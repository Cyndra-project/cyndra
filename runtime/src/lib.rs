...
//! ```bash
//! $ cargo cyndra init --axum my-axum-app
//! ```
//!
...
//!
//! ```toml
//! cyndra-shared-db = { version = "0.18.0", features = ["postgres"] }
...
pub use cyndra_service::{main, CustomError, Error, Factory, ResourceBuilder, Service};
