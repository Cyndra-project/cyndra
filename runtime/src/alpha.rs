...
pub async fn start(loader: impl Loader + Send + 'static, runner: impl Runner + Send + 'static) {
    ...
    let args = match Args::parse() {
        ...
        Err(e) => {
            ...
            let help_str = "[HINT]: Run cyndra with `cargo cyndra run`";
    ...
    println!(
        "cyndra-runtime executable started (version {})",
        crate::VERSION
    );
    ...
    #[cfg(feature = "setup-tracing")]
    {
        ...
        println!(
            ...
            {}",
            "=".repeat(63).yellow(),
            "Cyndra's default tracing subscriber is initialized!"
                .yellow()
                .bold(),
            "cyndra-runtime".italic(),
            r#"cyndra-runtime = { version = "...", default-features = false }"#.italic(),
            "=".repeat(63).yellow(),
        );
    }
