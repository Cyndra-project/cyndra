...
use cyndra_common::models::project::{ComputeTier, ProjectResponseBeta, ProjectUpdateRequestBeta};
...
impl Client {
    pub fn new(api_url: String, api_key: String, timeout: u64) -> Self {
        Self {
            inner: CyndraApiClient::new(api_url, Some(api_key), None, Some(timeout)),
        }
    }
