...
/// The return type of the [cyndra_runtime::main] function for the Thruster service.
///
/// ## Example
///
/// ```rust,no_run
/// use cyndra_thruster::CyndraThruster;
/// use thruster::{
///     context::basic_hyper_context::{generate_context, BasicHyperContext as Ctx, HyperRequest},
///     m, middleware_fn, App, HyperServer, MiddlewareNext, MiddlewareResult, ThrusterServer,
/// };
...
///
/// #[cyndra_runtime::main]
/// async fn thruster() -> CyndraThruster<HyperServer<Ctx, ()>> {
///     Ok(HyperServer::new(
///         App::<HyperRequest, Ctx, ()>::create(generate_context, ()).get("/", m![hello]),
///     ).into())
/// }
